"""
Django settings for fragrant_moon_40898 project.
...
ROOT_URLCONF = 'fragrant_moon_40898.urls'
...
WSGI_APPLICATION = 'fragrant_moon_40898.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_moon_40898 API",
    "DESCRIPTION": "API documentation for fragrant_moon_40898 App",
    "VERSION": "v1",
}
